...
#define ECHO_PIN 6      // Pin that listens to incoming pulse
#define LED_PIN1 2      // Standard green LED pin
#define LED_PIN2 3      // Standard green LED pin
#define LED_PIN3 4      // Standard green LED pin
#define LED_PIN4 5      // Standard green LED pin
...
void loop() {
  ...
  // reads in the incoming puls in microseconds
  duration =  read_ultrasonic_sensor();
  ...
  if(distance <= 25){
    ...
    // Print distance for debugging purpose
